...
![Site T1B - the view upstream. (John Forrest)](/assets/SiteDescriptions/T1/T1BViewupstream.JPG)
Site T01B - the view upstream (Nov.2021). (John Forrest)

![Site T1B - the view downstream. (John Forrest)](/assets/SiteDescriptions/T1/T1BViewdownstream.JPG)
